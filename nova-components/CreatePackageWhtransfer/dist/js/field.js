...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-create-package-whtransfer', __webpack_require__(3));
  Vue.component('detail-create-package-whtransfer', __webpack_require__(6));
  Vue.component('form-create-package-whtransfer', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c("div", [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "testing-code " }, [
      _c("header", [
        _vm._v("Item(s) not available in stock:\n            "),
        _c(
          "span",
          {
            staticClass: "btn btn-info border-2 copy-btn ml-auto",
            on: {
