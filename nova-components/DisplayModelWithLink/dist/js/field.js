...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-display-model-with-link', __webpack_require__(3));
  Vue.component('detail-display-model-with-link', __webpack_require__(6));
  Vue.component('form-display-model-with-link', __webpack_require__(9));
});
