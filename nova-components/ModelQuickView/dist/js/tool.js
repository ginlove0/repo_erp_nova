...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_spinner_src_PulseLoader_vue__ = __webpack_require__(143);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: { PulseLoader: __WEBPACK_IMPORTED_MODULE_0_vue_spinner_src_PulseLoader_vue___default.a },
    ...
    methods: {
        show: function show() {
            ...
            axios.get('/nova-vendor/model-quick-view/findDetail').then(function (res) {
        ...
        show1: function show1() {
            ...
            axios.get('/nova-vendor/model-quick-view/findDetailInADay').then(function (res) {
                _this2.displayData = res.data;
            }).catch(function (err) {
        ...
        date: function date(value, format) {
            if (value) {
                return __WEBPACK_IMPORTED_MODULE_1_moment___default()(String(value)).format(format || 'MM/DD/YY');
            }
        }
    },
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("2f1748e2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Model Quick View")]),
      _vm._v(" "),
      _c("div", { staticClass: "div-button" }, [
        _c(
          "button",
          { staticClass: "filter-button", on: { click: _vm.show1 } },
          [_vm._v("ToDay")]
        ),
        _vm._v(" "),
        _c(
          "button",
          { staticClass: "filter-button", on: { click: _vm.show } },
          [_vm._v("7 Days")]
        )
      ]),
      _vm._v(" "),
      _c("div", [
        _c("table", { staticClass: "w-full text-center table-view" }, [
          _vm._m(0),
          _vm._v(" "),
          _c(
            "tbody",
            { staticClass: "table-body" },
            _vm._l(_vm.displayData, function(model) {
              return _c("tr", { staticClass: "body-row" }, [
                _c("td", { staticClass: "column-in-row-table" }, [
                  _vm._v(_vm._s(_vm.date(model.Date, "hh:mm DD/MM")))
                ]),
                _vm._v(" "),
                _c("td", { staticClass: "column-in-row-table" }, [
                  _vm._v(_vm._s(model.Location))
                ]),
                _vm._v(" "),
                _c("td", { staticClass: "column-in-row-table" }, [
                  _vm._v(_vm._s(model.Supp))
                ]),
                _vm._v(" "),
                _c("td", { staticClass: "column-in-row-table" }, [
  ...
  function() {
    ...
    return _c("thead", { staticClass: "table-header" }, [
      _c("tr", { staticClass: "header-row" }, [
        _c("th", { staticClass: "column-in-header" }, [_vm._v("Date")]),
        _vm._v(" "),
        _c("th", { staticClass: "column-in-header" }, [_vm._v("Location")]),
        _vm._v(" "),
        _c("th", { staticClass: "column-in-header" }, [_vm._v("Supplier")]),
        _vm._v(" "),
        _c("th", { staticClass: "column-in-header" }, [_vm._v("Model")]),
        _vm._v(" "),
        _c("th", { staticClass: "column-in-header" }, [_vm._v("Condition")]),
        _vm._v(" "),
        _c("th", { staticClass: "column-in-header" }, [_vm._v("Qty")])
      ])
    ])
  }
]
