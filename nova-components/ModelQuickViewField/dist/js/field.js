...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-model-quick-view-field', __webpack_require__(3));
  Vue.component('detail-model-quick-view-field', __webpack_require__(6));
  Vue.component('form-model-quick-view-field', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        show: function show() {
            ...
            var url = '/api/ipsupply/findDetail';
    ...
    _c("table", [
      ...
      _c(
        ...
        _vm._l(_vm.displayData, function(model) {
          return _c("tr", [
            _c("td", [_vm._v(_vm._s(model.Model))]),
            _vm._v(" "),
            _c("td"),
            _vm._v(" "),
            _c("td")
