...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-creatable-hasmany-relation-field', __webpack_require__(13));
  Vue.component('detail-creatable-hasmany-relation-field', __webpack_require__(16));
  Vue.component('form-creatable-hasmany-relation-field', __webpack_require__(37));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        fetchData: function fetchData() {
            ...
            var resourceName = this.field.resourceName;
            var viaResource = this.resourceName;
            var resourceId = this.resourceId;
            var viaRelationship = this.field.attribute;
            var perPage = 5;
            var url = '/nova-api/' + resourceName + '?search=&page=1&perPage=' + perPage + '&viaResource=' + viaResource + '&viaResourceId=' + resourceId + '&viaRelationship=' + viaRelationship + '&relationshipType=hasMany';
