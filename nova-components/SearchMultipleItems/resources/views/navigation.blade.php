<router-link tag="h3" :to="{name: 'search-multiple-items'}" class="cursor-pointer flex items-center font-normal dim text-white mb-6 text-base no-underline">
