...
Nova.booting(function (Vue, router, store) {
  ...
  Vue.component('index-create-packages-shipping', __webpack_require__(7));
  Vue.component('detail-create-packages-shipping', __webpack_require__(10));
  Vue.component('form-create-packages-shipping', __webpack_require__(13));
});
