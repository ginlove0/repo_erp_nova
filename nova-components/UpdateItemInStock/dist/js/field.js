...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-update-item-in-stock', __webpack_require__(3));
  Vue.component('detail-update-item-in-stock', __webpack_require__(6));
  Vue.component('form-update-item-in-stock', __webpack_require__(9));
});
