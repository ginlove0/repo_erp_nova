...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-item-to-out-stock', __webpack_require__(3));
  Vue.component('detail-item-to-out-stock', __webpack_require__(6));
  Vue.component('form-item-to-out-stock', __webpack_require__(9));
});
