...
Nova.booting(function (Vue, router, store) {
  Vue.component('item-transfer-resource-tool', __webpack_require__(15));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SearchDropdown__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__DeteleAction__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ModelModal__ = __webpack_require__(47);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("70ddcc6f", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("f3aa09e4", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("7234debe", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
var render = function() {
  ...
  return _c("div", [
    ...
    _c(
      ...
      {
        staticClass:
          "table table-bordered table-form w-full table-whtransfer-modal"
      },
      [
        _vm._m(0),
        _vm._v(" "),
