...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__DeteleAction__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__DeteleAction___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__DeteleAction__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ModelModal__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ModelModal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__ModelModal__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: { Dropdown: __WEBPACK_IMPORTED_MODULE_0__SearchDropdown___default.a, DeleteAction: __WEBPACK_IMPORTED_MODULE_1__DeteleAction___default.a, ModelModal: __WEBPACK_IMPORTED_MODULE_2__ModelModal___default.a },
    ...
    methods: {
        ...
        fetchModelWhTransfer: function fetchModelWhTransfer() {
            var _this = this;

            axios.get('/nova-vendor/item-transfer-resource-tool/findModelInWhTransfer/' + this.resourceId).then(function (res) {
    ...
    mounted: function mounted() {
        ...
        Nova.$on('refetch-model', function () {
            _this3.fetchModelWhTransfer();
        });
...
var render = function() {
  ...
  return _c("div", [
      ...
      _c(
        ...
        [
          _vm._l(_vm.datas, function(item) {
            return _c("tr", { staticClass: "display-model" }, [
              _c("td", [
                _c("input", {
                  directives: [
                    {
            ...
            return _c("tr", [
              ...
              _c("td", [
                _c(
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _c("option", { attrs: { value: "1500" } }, [_vm._v("NOB")]),
                    _vm._v(" "),
                    _c("option", { attrs: { value: "2750" } }, [
                      _vm._v("USEA")
                    ]),
                    _vm._v(" "),
              ...
              _c("td", { staticClass: "table-name" }, [
                _c("textarea", {
                  ...
                  attrs: { placeholder: "Please enter note here..." },
    ...
    _c("div", [
      _c(
        "button",
        { staticClass: "active table-add-line", on: { click: _vm.addLine } },
    ...
    ? _c("div", { staticClass: "dropdown" }, [
        ...
        _c(
          ...
          [
            ...
            _c(
              "div",
              { staticClass: "dropdown-item", on: { click: _vm.onBlur } },
              [
                _c("div", [
                  _c("svg", { staticClass: "svg-icon" }, [
                    _c("path", {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-4fe7912c"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/js/components/DeteleAction.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4fe7912c", Component.options)
  } else {
    hotAPI.reload("data-v-4fe7912c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(14)("f3aa09e4", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4fe7912c\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./DeteleAction.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4fe7912c\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./DeteleAction.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        deleteSaleOrderModel: function deleteSaleOrderModel(id) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/nova-vendor/item-transfer-resource-tool/deleteItem/' + id).then(function (res) {
                Nova.$emit('refetch-model');
            }).catch(function (err) {
                console.log(err);
            });
    ...
    "button",
    {
      ...
      on: {
        click: function($event) {
          return _vm.deleteSaleOrderModel(_vm.id)
        }
      }
    },
    [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4fe7912c", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(14)("7234debe", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
    ...
    methods: {
        ...
        onSubmit: function onSubmit() {
            ...
            if (this.newModels[0].name != null) {
                axios.get('/nova-vendor/item-transfer-resource-tool/addNewModelInWhTransfer/' + JSON.stringify(this.newModels[0])).then(function (res) {
                    Nova.$emit('close');
        ...
        getAllManufactor: function getAllManufactor() {
            ...
            axios.get('/nova-vendor/item-transfer-resource-tool/findManufactor').then(function (res) {
        ...
        getAllCategory: function getAllCategory() {
            ...
            axios.get('/nova-vendor/item-transfer-resource-tool/findCategory').then(function (res) {
