...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-item-qty-base-condition', __webpack_require__(3));
  Vue.component('detail-item-qty-base-condition', __webpack_require__(11));
  Vue.component('form-item-qty-base-condition', __webpack_require__(14));
});
...
var update = __webpack_require__(7)("c54d1132", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getItemDetail: function getItemDetail() {
            ...
            if (this.field.value.ModelId !== null && this.field.value.ConditionId !== null) {
                axios.get('/api/ipsupply/findItemDetail/' + this.field.value.ModelId + '/' + this.field.value.ConditionId + '/' + this.field.value.WhLocationId).then(function (res) {
    ...
    computed: {
        limitedList: function limitedList() {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("a", { staticClass: "text-center", on: { click: _vm.mouseIn } }, [
        _vm._v(_vm._s(_vm.field.value.QTY))
      ]),
      _vm._v(" "),
      _vm.hover
        ? _c("transition", { attrs: { name: "modal-fade" } }, [
            _c("div", { staticClass: "modal-backdrop" }, [
              _c(
                ...
                [
                  _c("table", { staticClass: "table-modal" }, [
                    _c("thead", { staticClass: "modal-header" }, [
                      _c("tr", [
                        _c("th", { staticClass: "header-column" }, [
                          _vm._v("Model")
                        ]),
                        _vm._v(" "),
                        _c("th", { staticClass: "header-column" }, [
                    ...
                    _c(
                      "tbody",
                      _vm._l(_vm.displayData, function(item) {
                        return _c("tr", { staticClass: "table-modal-row" }, [
                  ...
                  _c("div", [
                    _c(
                      ...
                      {
                        staticClass:
                          "w-full btn btn-group-lg btn-dark submit-btn",
                        attrs: { type: "button" },
                        on: { click: _vm.close }
                      },
                      [
