...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        handleChange: function handleChange() {
            ...
            this.arrayItem.map(function (newitem) {
                if (newitem.length > 0) {
                    ...
                    var self = _this;
                    axios.get('/nova-vendor/search_multiple_us_item/' + newitem).then(function (res) {
                        console.log(res);
                        if (res.data[0]) {
        ...
        handleOutStock: function handleOutStock() {
            ...
            this.displayDatas.map(function (newitem) {
                // console.log(newitem.serialNumber)

                var self = _this2;
                axios.get('/nova-vendor/search_multiple_us_item/outStock/' + newitem.serialNumber).then(function (res) {
                    if (res && res.data) {
        ...
        handleInstock: function handleInstock() {
            ...
            this.displayDatas.map(function (newitem) {
                ...
                var self = _this3;
                axios.get('/nova-vendor/search_multiple_us_item/inStock/' + newitem.serialNumber).then(function (res) {
                    if (res && res.data) {
    ...
    _c(
      ...
      [
        ...
        _c("textarea", {
          ...
          style: _vm.styling,
          attrs: { type: "text", disabled: _vm.ableToInput },
