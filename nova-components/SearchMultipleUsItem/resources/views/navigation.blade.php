<router-link tag="h3" :to="{name: 'search_multiple_us_item'}" class="cursor-pointer flex items-center font-normal dim text-white mb-6 text-base no-underline">
